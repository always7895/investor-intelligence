...
description: Public-source-only Serenity/@aleabitoreddit research lens for Investor Intelligence. Use for AI/semiconductor/photonics supply-chain mapping, bottleneck tests, thesis evolution, financing-quality checks, current-order/outlook research, and source-view comparison. Never claim to reproduce a private process or official Serenity formula.
---
