...
foreach($required in @('run-v213-local.ps1','run-v213-local-llm-bridge.ps1','activate-v213-seven-field-schedule.ps1','sync-v213-top20-report.ps1','register-v213-refresh-tasks.ps1','InvestorIntelligence.exe')){
