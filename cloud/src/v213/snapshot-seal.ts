...
export const SNAPSHOT_LAZY_KEY_RE = /^v213:(?:identity:v2:(?:sym:[A-Z0-9_]|name:(?:1[0-5]|[0-9]))|quotes:v1|options:v[12]|bottleneck-top20:v3|prices:v1:(?:US|TAIWAN|SWEDEN|EUROPE|JAPAN|KOREA|UK|HK))$/;
export const SNAPSHOT_LAZY_BLOB_PREFIX = "blob:v1:";
const MAX_LAZY_KEYS = 80;
