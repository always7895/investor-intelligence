...
const INTERNATIONAL_OPTIONS_KNOWLEDGE_BASE: Record<string, InternationalOptionFact> = {
  ...
  "6857.T": {
    ...
    country: "日本",
    exchange: "東京證券交易所（TSE / OSE 期權）｜ 幣別：JPY 日圓",
    currency: "JPY",
    ibkrPath: "在 TWS 或 IBKR Mobile 搜尋「6857」，選擇「Advantest Corp (TSE - Stocks/Options)」，即可連通日本大阪交易所個股期權鏈！",
    callStrategy: "• 履約價挑選：全球 HBM3e/HBM4 測試機台 70%+ 絕對壟斷，長線爆發力強，絕不賣股！建議挑選價外 +15%～+25% 之月選合約。\n• 建議合約天數：30～60 天月選合約，收取高額時間價值（Theta）。",
    putStrategy: "• 履約價挑選：現價折價 15%～20% 支撐位掛單接盤，預留 100% 現金保證金。",
  },
  "6146.T": {
    symbol: "6146.T",
    name: "迪思科 / Disco Corp",
    ...
    callStrategy: "• 履約價挑選：全球半導體晶圓切割與研磨機 70%～80% 絕對壟斷，絕不賣股！建議挑選價外 +15%～+25% 之月選合約。\n• 建議合約天數：30～60 天月選合約。",
  ...
  "8035.T": {
    ...
    callStrategy: "• 履約價挑選：全球 EUV 塗布顯影機 90% 壟斷霸主，絕不賣股！建議挑選價外 +15%～+20% 之月選合約。\n• 建議合約天數：30～60 天月選合約。",
    putStrategy: "• 履約價挑選：現價折價 10%～20% 支撐位掛單接盤。",
  },
  "000660.KS": {
    symbol: "000660.KS",
    name: "SK海力士 / SK Hynix",
    country: "韓國",
    exchange: "韓國交易所（KRX 期權/期貨）｜ 幣別：KRW 韓元",
    currency: "KRW",
    ibkrPath: "在 TWS 或 IBKR Mobile 搜尋「000660」，選擇「SK Hynix (KRX - Stocks/Options)」！",
    callStrategy: "• 履約價挑選：NVIDIA Blackwell HBM3e 獨家首選供應商，超級週期爆發，絕不賣股！建議挑選價外 +20%～+30% 之月選合約。\n• 建議合約天數：30～60 天月選合約。",
    putStrategy: "• 履約價挑選：現價折價 15%～25% 強支撐位掛單接盤。",
  },
  "042700.KS": {
    symbol: "042700.KS",
    name: "韓美半導體 / Hanmi Semiconductor",
    country: "韓國",
    exchange: "韓國交易所（KRX）｜ 幣別：KRW 韓元",
    currency: "KRW",
    ibkrPath: "在 TWS 或 IBKR Mobile 搜尋「042700」，進入韓國 KRX 股票市場！",
    callStrategy: "• 履約價挑選：HBM 核心熱壓合機 Dual TC Bonder 85%+ 壟斷，建議現貨 100% 抱緊，或挑選價外 +25%～+35% 深度防守！\n• 建議合約天數：30～60 天月選合約。",
    putStrategy: "• 履約價挑選：現價折價 20%～30% 支撐位掛單接盤。",
  },
  BESI: {
    symbol: "BESI",
    name: "貝思半導體 / BE Semiconductor",
    country: "荷蘭/歐洲",
    exchange: "Euronext Amsterdam (AEB) ｜ 幣別：EUR 歐元",
    currency: "EUR",
    ibkrPath: "在 TWS 或 IBKR Mobile 搜尋「BESI」，選擇「BE Semiconductor (AEB - Stocks/Options)」！",
    callStrategy: "• 履約價挑選：全球 Hybrid Bonding 混合鍵合先進封裝設備絕對霸主，絕不賣股！建議挑選價外 +15%～+25% 之月選合約。\n• 建議合約天數：30～60 天月選合約。",
    putStrategy: "• 履約價挑選：現價折價 15%～20% 支撐位掛單接盤。",
  },
  TSM: {
    symbol: "TSM",
