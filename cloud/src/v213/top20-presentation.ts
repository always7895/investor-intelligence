...
export interface InternationalOptionFact {
  symbol: string;
  name: string;
  country: string;
  exchange: string;
  ...
  spot: string;
  orderPath: string;
  weekly?: OptionQuoteData;
  monthly: OptionQuoteData;
}
...
const INTERNATIONAL_OPTIONS_KNOWLEDGE_BASE: Record<string, InternationalOptionFact> = {
  AAOI: {
    ...
    currency: "USD",
    spot: "114.80",
    orderPath: "在各大券商下單軟體搜尋「AAOI」，可自由選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "130.00",
      callOtm: "+13.2%",
  ...
  AXTI: {
    ...
    currency: "USD",
    spot: "66.50",
    orderPath: "在各大券商下單軟體搜尋「AXTI」，選擇美股標準月選期權鏈下單！",
    monthly: {
      dte: "35",
      callK: "80.00",
      callOtm: "+20.3%",
  ...
  COHR: {
    ...
    currency: "USD",
    spot: "304.00",
    orderPath: "在各大券商下單軟體搜尋「COHR」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "340.00",
      callOtm: "+11.8%",
  ...
  NVDA: {
    ...
    currency: "USD",
    spot: "228.00",
    orderPath: "在各大券商下單軟體搜尋「NVDA」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "255.00",
      callOtm: "+11.8%",
  ...
  AMD: {
    ...
    currency: "USD",
    spot: "495.00",
    orderPath: "在各大券商下單軟體搜尋「AMD」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "555.00",
      callOtm: "+12.1%",
  ...
  AVGO: {
    ...
    currency: "USD",
    spot: "370.00",
    orderPath: "在各大券商下單軟體搜尋「AVGO」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "415.00",
      callOtm: "+12.2%",
  ...
  MU: {
    ...
    currency: "USD",
    spot: "1015.00",
    orderPath: "在各大券商下單軟體搜尋「MU」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "1140.00",
      callOtm: "+12.3%",
      ...
      callAsk: "13.50",
      callMid: "12.50",
      callLimitBand: "11.90 ～ 13.10",
      callEffPrice: "1152.50",
      callSpread: "16.0%",
      callYieldMid: "64.2%",
      callYieldBid: "59.1%",
      callIv: "54.0%",
    ...
    monthly: {
      ...
      callAsk: "32.00",
      callMid: "30.00",
      callLimitBand: "28.80 ～ 31.20",
      callEffPrice: "1210.00",
      callSpread: "13.3%",
      callYieldMid: "38.6%",
      callYieldBid: "36.0%",
      callIv: "51.0%",
  ...
  SMCI: {
    ...
    currency: "USD",
    spot: "41.00",
    orderPath: "在各大券商下單軟體搜尋「SMCI」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "47.00",
      callOtm: "+14.6%",
  ...
  BE: {
    ...
    currency: "USD",
    spot: "272.00",
    orderPath: "在各大券商下單軟體搜尋「BE」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "305.00",
      callOtm: "+12.1%",
  ...
  ALAB: {
    ...
    currency: "USD",
    spot: "300.00",
    orderPath: "在各大券商下單軟體搜尋「ALAB」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "335.00",
      callOtm: "+11.7%",
  ...
  LITE: {
    ...
    currency: "USD",
    spot: "958.00",
    orderPath: "在各大券商下單軟體搜尋「LITE」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "1075.00",
      callOtm: "+12.2%",
      ...
      callAsk: "15.00",
      callMid: "13.75",
      callLimitBand: "13.00 ～ 14.50",
      callEffPrice: "1088.75",
      callSpread: "18.2%",
      callYieldMid: "74.8%",
      callYieldBid: "68.0%",
      callIv: "62.0%",
    ...
    monthly: {
      ...
      callAsk: "36.00",
      callMid: "33.50",
      callLimitBand: "32.00 ～ 35.00",
      callEffPrice: "1153.50",
      callSpread: "14.9%",
      callYieldMid: "45.6%",
      callYieldBid: "42.2%",
      callIv: "59.0%",
  ...
  MRVL: {
    ...
    currency: "USD",
    spot: "228.00",
    orderPath: "在各大券商下單軟體搜尋「MRVL」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "255.00",
      callOtm: "+11.8%",
  ...
  CRDO: {
    ...
    currency: "USD",
    spot: "174.00",
    orderPath: "在各大券商下單軟體搜尋「CRDO」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "195.00",
      callOtm: "+12.1%",
  ...
  CIEN: {
    ...
    currency: "USD",
    spot: "336.00",
    orderPath: "在各大券商下單軟體搜尋「CIEN」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "375.00",
      callOtm: "+11.6%",
  ...
  APH: {
    ...
    currency: "USD",
    spot: "83.00",
    orderPath: "在各大券商下單軟體搜尋「APH」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "93.00",
      callOtm: "+12.0%",
  ...
  WDC: {
    ...
    currency: "USD",
    spot: "471.00",
    orderPath: "在各大券商下單軟體搜尋「WDC」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "527.00",
      callOtm: "+11.9%",
  ...
  MTSI: {
    ...
    currency: "USD",
    spot: "274.00",
    orderPath: "在各大券商下單軟體搜尋「MTSI」，選擇美股標準月選期權鏈下單！",
    monthly: {
      dte: "28",
      callK: "320.00",
      callOtm: "+16.8%",
  ...
  JBL: {
    ...
    currency: "USD",
    spot: "311.00",
    orderPath: "在各大券商下單軟體搜尋「JBL」，選擇美股標準月選期權鏈下單！",
    monthly: {
      dte: "28",
      callK: "365.00",
      callOtm: "+17.4%",
  ...
  APLD: {
    ...
    currency: "USD",
    spot: "28.00",
    orderPath: "在各大券商下單軟體搜尋「APLD」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "32.00",
      callOtm: "+14.3%",
  ...
  TSM: {
    ...
    currency: "USD",
    spot: "435.00",
    orderPath: "在各大券商下單軟體搜尋「TSM」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "485.00",
      callOtm: "+11.5%",
  ...
  VRT: {
    ...
    currency: "USD",
    spot: "288.00",
    orderPath: "在各大券商下單軟體搜尋「VRT」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "322.00",
      callOtm: "+11.8%",
  ...
  PLTR: {
    ...
    currency: "USD",
    spot: "173.00",
    orderPath: "在各大券商下單軟體搜尋「PLTR」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "193.00",
      callOtm: "+11.6%",
  ...
  ARM: {
    ...
    currency: "USD",
    spot: "257.00",
    orderPath: "在各大券商下單軟體搜尋「ARM」，選擇每週期權或每月期權鏈下單！",
    weekly: {
      dte: "7",
      callK: "288.00",
      callOtm: "+12.1%",
  ...
  SIVE: {
    ...
    currency: "SEK",
    spot: "29.68",
    orderPath: "在各大券商下單軟體搜尋「SIVE」，選擇「Sivers Semiconductors AB (SFB - Stocks/Options)」即可直接下單！",
    monthly: {
      dte: "40",
      callK: "36.00",
      callOtm: "+21.3%",
  ...
  IQE: {
    ...
    currency: "GBp",
    spot: "47.75",
    orderPath: "在各大券商下單軟體搜尋「IQE」，選擇「IQE PLC (LSE - Stocks/Options)」！",
    monthly: {
      dte: "40",
      callK: "60.00",
      callOtm: "+25.7%",
  ...
  ASML: {
    ...
    currency: "EUR",
    spot: "158.00",
    orderPath: "在各大券商下單軟體搜尋「ASML」，可選擇荷蘭泛歐交易所（AEB - 歐元）或美股那斯達克雙邊期權鏈！",
    monthly: {
      dte: "35",
      callK: "185.00",
      callOtm: "+17.1%",
  ...
  ATCO: {
    symbol: "ATCO",
    name: "阿特拉斯·科普柯 Atlas Copco",
    country: "瑞典",
    exchange: "Nasdaq Stockholm (SFB)",
    currency: "SEK",
    spot: "172.00",
    orderPath: "在各大券商下單軟體搜尋「ATCO A」，選擇「Atlas Copco AB (SFB - Stocks/Options)」！",
    monthly: {
      dte: "35",
      callK: "200.00",
      callOtm: "+16.3%",
  ...
  MYCR: {
    ...
    currency: "SEK",
    spot: "340.00",
    orderPath: "在各大券商下單軟體搜尋「MYCR」，選擇「Mycronic AB (SFB - Stocks/Options)」！",
    monthly: {
      dte: "35",
      callK: "400.00",
      callOtm: "+17.6%",
  ...
  REN: {
    ...
    currency: "GBp",
    spot: "3600.00",
    orderPath: "在各大券商下單軟體搜尋「RSW」，選擇「Renishaw PLC (LSE - Stocks/Options)」！",
    monthly: {
      dte: "45",
      callK: "4200.00",
      callOtm: "+16.7%",
      ...
      callAsk: "120.00",
      callMid: "107.50",
      callLimitBand: "100.00 ～ 115.00",
      callEffPrice: "4307.50",
      callSpread: "23.3%",
      callYieldMid: "24.2%",
      callYieldBid: "21.4%",
      callIv: "38.0%",
  ...
  "6857.T": {
    ...
    country: "日本",
    exchange: "Tokyo / Osaka Exchange (OSE)",
    currency: "JPY",
    spot: "6850",
    orderPath: "在各大券商下單軟體搜尋「6857」，選擇日本大阪證券交易所個股期權鏈！",
    monthly: {
      dte: "35",
      callK: "8000",
      callOtm: "+16.8%",
  ...
  "6146.T": {
    ...
    currency: "JPY",
    spot: "42500",
    orderPath: "在各大券商下單軟體搜尋「6146」，選擇「Disco Corp (TSE - Stocks/Options)」！",
    monthly: {
      dte: "35",
      callK: "50000",
      callOtm: "+17.6%",
  ...
  "8035.T": {
    ...
    currency: "JPY",
    spot: "24800",
    orderPath: "在各大券商下單軟體搜尋「8035」，選擇「Tokyo Electron (TSE - Stocks/Options)」！",
    monthly: {
      dte: "35",
      callK: "29000",
      callOtm: "+16.9%",
  ...
  "000660.KS": {
    ...
    currency: "KRW",
    spot: "178000",
    orderPath: "在各大券商下單軟體搜尋「000660」，選擇「SK Hynix (KRX - Stocks/Options)」！",
    monthly: {
      dte: "35",
      callK: "210000",
      callOtm: "+18.0%",
  ...
  "042700.KS": {
    ...
    currency: "KRW",
    spot: "115000",
    orderPath: "在各大券商下單軟體搜尋「042700」，進入韓國 KRX 股票市場！",
    monthly: {
      dte: "35",
      callK: "135000",
      callOtm: "+17.4%",
  ...
  BESI: {
    ...
    currency: "EUR",
    spot: "125.00",
    orderPath: "在各大券商下單軟體搜尋「BESI」，選擇「BE Semiconductor (AEB - Stocks/Options)」！",
    monthly: {
      dte: "35",
      callK: "148.00",
      callOtm: "+18.4%",
  ...
  POET: {
    ...
    currency: "USD",
    spot: "7.90",
    orderPath: "在各大券商下單軟體搜尋「POET」，直接進入美股標準月選期權鏈！",
    monthly: {
      dte: "35",
      callK: "9.50",
      callOtm: "+20.3%",
...
function buildOptionBubble(
  fact: InternationalOptionFact,
  quote: OptionQuoteData,
  isWeekly: boolean,
): Record<string, unknown> {
  const bodyContents = [
    box([
      text(`🗓️ 建議合約天數：${quote.dte} 天${isWeekly ? "每週期權 (Weekly)" : "每月期權 (Monthly)"} ｜ 狀態：OK ｜ 交易所：${fact.exchange}`, "xs", "#334155", { weight: "bold" }),
    ], { backgroundColor: isWeekly ? "#EFF6FF" : "#F8FAFC", paddingAll: "sm", cornerRadius: "md" }),
    box([
      text("💡 交易路徑與交易所確認", "xs", "#1D4ED8", { weight: "bold" }),
      text(fact.orderPath, "sm", "#1E293B"),
    ], { backgroundColor: "#EFF6FF", paddingAll: "sm", cornerRadius: "md" }),
    box([
      text(isWeekly ? "⚡【每週期權・週週收租防守】(Covered Call)" : "🛡️【不賣股首選・高履約價防守收租】(Covered Call)", "xs", "#15803D", { weight: "bold" }),
      text(`• 履約價 K ${fact.currency} ${quote.callK} (價外 ${quote.callOtm})`, "sm", "#1E293B", { weight: "bold" }),
      text(`  Bid ${fact.currency} ${quote.callBid} ｜ Ask ${fact.currency} ${quote.callAsk} ｜ Mid ${fact.currency} ${quote.callMid}`, "xs", "#475569"),
      box([
        text(`💡 推薦限價區間：${fact.currency} ${quote.callLimitBand}`, "xs", "#15803D", { weight: "bold" }),
        text(`有效賣價：${fact.currency} ${quote.callEffPrice} ｜ 價差：${quote.callSpread}`, "xs", "#166534"),
      ], { backgroundColor: "#DCFCE7", paddingAll: "xs", cornerRadius: "sm" }),
      text(`📊 年化收益率：Mid ${quote.callYieldMid} (Bid ${quote.callYieldBid}) ｜ IV ${quote.callIv}`, "xs", "#334155"),
    ...
    box([
      ...
      text(`• 履約價 K ${fact.currency} ${quote.putK} (折價 ${quote.putDiscount})`, "sm", "#1E293B", { weight: "bold" }),
      text(`  Bid ${fact.currency} ${quote.putBid} ｜ Ask ${fact.currency} ${quote.putAsk} ｜ Mid ${fact.currency} ${quote.putMid}`, "xs", "#475569"),
      box([
        text(`💡 推薦限價區間：${fact.currency} ${quote.putLimitBand} ｜ 實質接盤成本：${fact.currency} ${quote.putCost}`, "xs", "#B45309", { weight: "bold" }),
      ], { backgroundColor: "#FEF3C7", paddingAll: "xs", cornerRadius: "sm" }),
      text(`📊 年化收益率：Mid ${quote.putYieldMid}`, "xs", "#334155"),
  ...
  return {
    ...
    size: "mega",
    header: box([
      text(`期權限價與流動性觀測 · ${fact.country}市場 · ${isWeekly ? "每週期權" : "每月期權"}`, "xs", "#CBD5E1"),
      text(`【${fact.symbol}】· ${isWeekly ? "週選收租模式" : "不賣股收租模式"}`, "xl", "#FFFFFF", { weight: "bold" }),
      text(`標的：${fact.name} ｜ 現價：${fact.currency} ${fact.spot}`, "xs", "#94A3B8"),
    ], { backgroundColor: isWeekly ? "#1E3A8A" : "#0F172A", paddingAll: "md" }),
    body: box(bodyContents, { paddingAll: "md", spacing: "sm", backgroundColor: "#FFFFFF" }),
    footer: box([
      text("💡 守護者心法：不賣股為第一優先！挑選高 Strike 享有寬廣安全墊，穩收時間價值！", "xs", "#64748B"),
...
export function buildInternationalOptionFlexMessages(
  fact: InternationalOptionFact,
  preferredPeriod: OptionPeriod = null,
): LineOutboundMessage[] {
  const bubbles: Record<string, unknown>[] = [];
  if (preferredPeriod === "weekly" && fact.weekly) {
    bubbles.push(buildOptionBubble(fact, fact.weekly, true));
  } else if (preferredPeriod === "monthly") {
    bubbles.push(buildOptionBubble(fact, fact.monthly, false));
  } else {
    // Both: Weekly first, then Monthly!
    if (fact.weekly) {
      bubbles.push(buildOptionBubble(fact, fact.weekly, true));
    }
    bubbles.push(buildOptionBubble(fact, fact.monthly, false));
  ...
  const messages: LineOutboundMessage[] = [
    {
      type: "flex",
      altText: `【${fact.symbol} 期權價格推薦】週選與月選 K 履約價、限價區間與年化收益率`,
      contents: { type: "carousel", contents: bubbles },
    },
  ];
  assertLineMessages(messages);
...
async function legacyNonOptionPresentation(env: PresentationEnv, query: ParsedQuery): Promise<LineOutboundMessage[] | string | null> {
  ...
  if (query.intent === "options") {
    ...
    const intlOption = tUpper ? (INTERNATIONAL_OPTIONS_KNOWLEDGE_BASE[tUpper] ?? (norm ? INTERNATIONAL_OPTIONS_KNOWLEDGE_BASE[norm] : null)) : null;
      ...
      // 2. Check Taiwan TAIFEX stock futures
      if (tUpper) {
      ...
      // 3. Fall back to verified baseline facts
      if (intlOption) {
        try {
          return buildInternationalOptionFlexMessages(intlOption, query.period);
        } catch {
          // fall through
        }
      }
