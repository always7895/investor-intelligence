...
const INTERNATIONAL_OPTIONS_KNOWLEDGE_BASE: Record<string, InternationalOptionFact> = {
  AAOI: {
    symbol: "AAOI",
    name: "祥茂光電 / Applied Optoelectronics",
    country: "美國",
    exchange: "Nasdaq / CBOE / OPRA",
    currency: "USD",
    spot: "32.50",
    dte: "30",
    ibkrPath: "在各大券商下單軟體搜尋「AAOI」，選擇美股每週期權鏈下單！",
    callK: "39.00",
    callOtm: "+20.0%",
    callBid: "2.30",
    callAsk: "2.55",
    callMid: "2.42",
    callLimitBand: "2.35 ～ 2.45",
    callEffPrice: "41.42",
    callSpread: "10.3%",
    callYieldMid: "89.5%",
    callYieldBid: "85.1%",
  ...
  AXTI: {
    ...
    spot: "5.20",
    dte: "35",
    ibkrPath: "在各大券商下單軟體搜尋「AXTI」，選擇美股月選期權鏈下單！",
    callK: "6.50",
    callOtm: "+25.0%",
    callBid: "0.35",
    callAsk: "0.45",
    callMid: "0.40",
    callLimitBand: "0.38 ～ 0.42",
    callEffPrice: "6.90",
    callSpread: "25.0%",
    callYieldMid: "80.1%",
    callYieldBid: "70.1%",
  ...
  COHR: {
    ...
    spot: "102.50",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「COHR」，選擇美股每週期權鏈下單！",
    callK: "120.00",
    callOtm: "+17.1%",
    callBid: "3.60",
    callAsk: "4.00",
    callMid: "3.80",
    callLimitBand: "3.70 ～ 3.85",
    callEffPrice: "123.80",
    callSpread: "10.5%",
    callYieldMid: "48.3%",
    callYieldBid: "45.8%",
  ...
  NVDA: {
    ...
    spot: "138.50",
    dte: "21",
    ibkrPath: "在各大券商下單軟體搜尋「NVDA」，選擇美股每週期權鏈下單！",
    callK: "160.00",
    callOtm: "+15.5%",
    callBid: "2.20",
    callAsk: "2.40",
    callMid: "2.30",
    callLimitBand: "2.25 ～ 2.35",
    callEffPrice: "162.30",
    callSpread: "8.7%",
    callYieldMid: "28.8%",
    callYieldBid: "27.6%",
  ...
  AMD: {
    ...
    spot: "162.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「AMD」，選擇美股每週期權鏈下單！",
    callK: "190.00",
    callOtm: "+17.3%",
    callBid: "3.40",
    callAsk: "3.80",
    callMid: "3.60",
    callLimitBand: "3.50 ～ 3.65",
    callEffPrice: "193.60",
    callSpread: "11.1%",
    callYieldMid: "28.9%",
    callYieldBid: "27.3%",
  ...
  AVGO: {
    ...
    spot: "178.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「AVGO」，選擇美股每週期權鏈下單！",
    callK: "210.00",
    callOtm: "+18.0%",
    callBid: "3.10",
    callAsk: "3.50",
    callMid: "3.30",
    callLimitBand: "3.20 ～ 3.35",
    callEffPrice: "213.30",
    callSpread: "12.1%",
    callYieldMid: "24.1%",
    callYieldBid: "22.7%",
  ...
  MU: {
    ...
    spot: "118.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「MU」，選擇美股每週期權鏈下單！",
    callK: "140.00",
    callOtm: "+18.6%",
    callBid: "2.60",
    callAsk: "3.00",
    callMid: "2.80",
    callLimitBand: "2.70 ～ 2.85",
    callEffPrice: "142.80",
    callSpread: "14.3%",
    callYieldMid: "30.9%",
    callYieldBid: "28.7%",
    ...
    putAsk: "2.10",
    putMid: "1.90",
    putLimitBand: "1.80 ～ 1.95",
    putCost: "98.10",
    putYieldMid: "24.7%",
  },
  SMCI: {
    symbol: "SMCI",
    name: "美超微電腦 / Supermicro",
    country: "美國",
    exchange: "Nasdaq / CBOE / OPRA",
    currency: "USD",
    spot: "45.00",
    dte: "21",
    ibkrPath: "在各大券商下單軟體搜尋「SMCI」，選擇美股每週期權鏈下單！",
    callK: "55.00",
    callOtm: "+22.2%",
    callBid: "2.10",
    callAsk: "2.45",
    callMid: "2.27",
    callLimitBand: "2.15 ～ 2.30",
    callEffPrice: "57.27",
    callSpread: "15.4%",
    callYieldMid: "87.6%",
    callYieldBid: "81.0%",
    ...
    putAsk: "1.80",
    putMid: "1.65",
    putLimitBand: "1.55 ～ 1.70",
    putCost: "36.35",
    putYieldMid: "75.5%",
  },
  BE: {
    symbol: "BE",
    name: "布魯姆能源 / Bloom Energy",
    country: "美國",
    exchange: "NYSE / CBOE / OPRA",
    currency: "USD",
    spot: "22.50",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「BE」，選擇美股每週期權鏈下單！",
    callK: "27.00",
    callOtm: "+20.0%",
    callBid: "0.95",
    callAsk: "1.15",
    callMid: "1.05",
    callLimitBand: "1.00 ～ 1.10",
    callEffPrice: "28.05",
    callSpread: "19.0%",
    callYieldMid: "60.8%",
    callYieldBid: "55.0%",
    ...
    putAsk: "0.90",
    putMid: "0.80",
    putLimitBand: "0.75 ～ 0.85",
    putCost: "18.20",
    putYieldMid: "54.8%",
  },
  ALAB: {
    symbol: "ALAB",
    name: "阿斯特拉 / Astera Labs",
    country: "美國",
    exchange: "Nasdaq / CBOE / OPRA",
    currency: "USD",
    spot: "92.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「ALAB」，選擇美股每週期權鏈下單！",
    callK: "110.00",
    callOtm: "+19.6%",
    callBid: "2.80",
    callAsk: "3.30",
    callMid: "3.05",
    callLimitBand: "2.90 ～ 3.10",
    callEffPrice: "113.05",
    callSpread: "16.4%",
    callYieldMid: "43.2%",
    callYieldBid: "39.6%",
  ...
  LITE: {
    ...
    spot: "74.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「LITE」，選擇美股每週期權鏈下單！",
    callK: "88.00",
    callOtm: "+18.9%",
    callBid: "2.10",
    callAsk: "2.50",
    callMid: "2.30",
    callLimitBand: "2.20 ～ 2.35",
    callEffPrice: "90.30",
    callSpread: "17.4%",
    callYieldMid: "40.5%",
    callYieldBid: "36.9%",
  ...
  MRVL: {
    ...
    spot: "85.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「MRVL」，選擇美股每週期權鏈下單！",
    callK: "100.00",
    callOtm: "+17.6%",
    callBid: "2.00",
    callAsk: "2.40",
    callMid: "2.20",
    callLimitBand: "2.10 ～ 2.25",
    callEffPrice: "102.20",
    callSpread: "18.2%",
    callYieldMid: "33.7%",
    callYieldBid: "30.6%",
  ...
  CRDO: {
    ...
    spot: "42.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「CRDO」，選擇美股每週期權鏈下單！",
    callK: "50.00",
    callOtm: "+19.0%",
    callBid: "1.35",
    callAsk: "1.65",
    callMid: "1.50",
    callLimitBand: "1.40 ～ 1.55",
    callEffPrice: "51.50",
    callSpread: "20.0%",
    callYieldMid: "46.5%",
    callYieldBid: "41.9%",
  ...
  CIEN: {
    ...
    spot: "68.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「CIEN」，選擇美股每週期權鏈下單！",
    callK: "80.00",
    callOtm: "+17.6%",
    callBid: "1.50",
    callAsk: "1.85",
    callMid: "1.67",
    callLimitBand: "1.55 ～ 1.70",
    callEffPrice: "81.67",
    callSpread: "21.0%",
    callYieldMid: "32.0%",
    callYieldBid: "28.7%",
  ...
  APH: {
    ...
    spot: "72.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「APH」，選擇美股每週期權鏈下單！",
    callK: "85.00",
    callOtm: "+18.1%",
    callBid: "1.20",
    callAsk: "1.50",
    callMid: "1.35",
    callLimitBand: "1.25 ～ 1.40",
    callEffPrice: "86.35",
    callSpread: "22.2%",
    callYieldMid: "24.4%",
    callYieldBid: "21.7%",
    ...
    putAsk: "1.10",
    putMid: "0.95",
    putLimitBand: "0.85 ～ 1.00",
    putCost: "61.05",
    putYieldMid: "19.9%",
  },
  WDC: {
    symbol: "WDC",
    name: "威騰電子 / Western Digital",
    country: "美國",
    exchange: "Nasdaq / CBOE / OPRA",
    currency: "USD",
    spot: "78.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「WDC」，選擇美股每週期權鏈下單！",
    callK: "93.00",
    callOtm: "+19.2%",
    callBid: "1.75",
    callAsk: "2.15",
    callMid: "1.95",
    callLimitBand: "1.80 ～ 2.00",
    callEffPrice: "94.95",
    callSpread: "20.5%",
    callYieldMid: "32.6%",
    callYieldBid: "29.2%",
  ...
  MTSI: {
    ...
    spot: "112.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「MTSI」，選擇美股月選期權鏈下單！",
    callK: "133.00",
    callOtm: "+18.8%",
    callBid: "2.20",
    callAsk: "2.70",
    callMid: "2.45",
    callLimitBand: "2.30 ～ 2.50",
    callEffPrice: "135.45",
    callSpread: "20.4%",
    callYieldMid: "28.5%",
    callYieldBid: "25.6%",
  ...
  JBL: {
    ...
    spot: "132.00",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「JBL」，選擇美股月選期權鏈下單！",
    callK: "155.00",
    callOtm: "+17.4%",
    callBid: "2.10",
    callAsk: "2.60",
    callMid: "2.35",
    callLimitBand: "2.20 ～ 2.40",
    callEffPrice: "157.35",
    callSpread: "21.3%",
    callYieldMid: "23.2%",
    callYieldBid: "20.7%",
  ...
  APLD: {
    symbol: "APLD",
    name: "應用數位 / Applied Digital",
    country: "美國",
    exchange: "Nasdaq / CBOE / OPRA",
    currency: "USD",
    spot: "9.50",
    dte: "28",
    ibkrPath: "在各大券商下單軟體搜尋「APLD」，選擇美股每週期權鏈下單！",
    callK: "11.50",
    callOtm: "+21.1%",
    callBid: "0.65",
    callAsk: "0.80",
    callMid: "0.72",
    callLimitBand: "0.68 ～ 0.75",
    callEffPrice: "12.22",
    callSpread: "20.7%",
    callYieldMid: "98.8%",
    callYieldBid: "89.2%",
  ...
  SIVE: {
    ...
    spot: "28.50",
    dte: "40",
    ibkrPath: "在各大券商下單軟體搜尋「SIVE」，選擇「Sivers Semiconductors AB (SFB - Stocks/Options)」即可直接下單！",
    callK: "35.00",
    callOtm: "+22.8%",
    callBid: "1.65",
    callAsk: "1.95",
  ...
  IQE: {
    ...
    spot: "48.00",
    dte: "40",
    ibkrPath: "在各大券商下單軟體搜尋「IQE」，選擇「IQE PLC (LSE - Stocks/Options)」！",
    callK: "60.00",
    callOtm: "+25.0%",
    callBid: "3.20",
    callAsk: "3.80",
  ...
  ASML: {
    ...
    spot: "158.00",
    dte: "35",
    ibkrPath: "在各大券商下單軟體搜尋「ASML」，選擇荷蘭泛歐交易所（AEB - 歐元）或美股那斯達克雙邊期權鏈！",
    callK: "185.00",
    callOtm: "+17.1%",
    callBid: "4.80",
    callAsk: "5.40",
  ...
  ARM: {
    ...
    spot: "252.00",
    dte: "14",
    ibkrPath: "在各大券商下單軟體搜尋「ARM」，直接進入美股每週期權鏈！",
    callK: "295.00",
    callOtm: "+17.1%",
    callBid: "6.20",
    callAsk: "6.80",
  ...
  ATCO: {
    ...
    spot: "207.00",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「ATCO A」，選擇「Atlas Copco AB (SFB - Stocks/Options)」！",
    callK: "240.00",
    callOtm: "+15.9%",
    callBid: "5.20",
    callAsk: "6.10",
  ...
  MYCR: {
    ...
    spot: "319.00",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「MYCR」，選擇「Mycronic AB (SFB - Stocks/Options)」！",
    callK: "400.00",
    callOtm: "+25.4%",
    callBid: "14.50",
    callAsk: "17.00",
  ...
  REN: {
    ...
    spot: "51.20",
    dte: "40",
    ibkrPath: "在各大券商下單軟體搜尋「RSW」，選擇「Renishaw PLC (LSE - Stocks/Options)」！",
    callK: "60.00",
    callOtm: "+17.2%",
    callBid: "1.60",
    callAsk: "2.00",
  ...
  TSM: {
    ...
    spot: "428.90",
    dte: "14",
    ibkrPath: "在各大券商下單軟體搜尋「TSM」，選擇「TSM (NYSE - Stocks/Options)」，即可進入全球最具流動性之美股每週期權鏈！",
    callK: "500.00",
    callOtm: "+16.6%",
    callBid: "8.50",
    callAsk: "9.30",
  ...
  "6857.T": {
    ...
    spot: "33800",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「6857」，選擇「Advantest Corp (TSE - Stocks/Options)」，即可連通日本大阪交易所個股期權鏈！",
    callK: "40000",
    callOtm: "+18.3%",
    callBid: "1250",
    callAsk: "1450",
  ...
  "6146.T": {
    ...
    spot: "53890",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「6146」，選擇「Disco Corp (TSE - Stocks/Options)」！",
    callK: "62000",
    callOtm: "+15.1%",
    callBid: "1900",
    callAsk: "2200",
  ...
  "8035.T": {
    ...
    spot: "54000",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「8035」，選擇「Tokyo Electron (TSE - Stocks/Options)」！",
    callK: "62000",
    callOtm: "+14.8%",
    callBid: "1800",
    callAsk: "2100",
  ...
  "000660.KS": {
    ...
    spot: "179000",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「000660」，選擇「SK Hynix (KRX - Stocks/Options)」！",
    callK: "220000",
    callOtm: "+22.9%",
    callBid: "7800",
    callAsk: "9200",
  ...
  "042700.KS": {
    ...
    spot: "244000",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「042700」，進入韓國 KRX 股票市場！",
    callK: "300000",
    callOtm: "+23.0%",
    callBid: "11000",
    callAsk: "13500",
  ...
  BESI: {
    ...
    spot: "192.00",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「BESI」，選擇「BE Semiconductor (AEB - Stocks/Options)」！",
    callK: "230.00",
    callOtm: "+19.8%",
    callBid: "8.40",
    callAsk: "9.80",
  ...
  VRT: {
    ...
    spot: "280.50",
    dte: "14",
    ibkrPath: "在各大券商下單軟體搜尋「VRT」，選擇「VRT (NYSE - Stocks/Options)」直接連通每週期權鏈！",
    callK: "325.00",
    callOtm: "+15.9%",
    callBid: "7.20",
    callAsk: "8.00",
  ...
  PLTR: {
    ...
    spot: "174.30",
    dte: "14",
    ibkrPath: "在各大券商下單軟體搜尋「PLTR」，直接進入美股每週期權鏈，交易量巨大！",
    callK: "205.00",
    callOtm: "+17.6%",
    callBid: "4.80",
    callAsk: "5.30",
  ...
  POET: {
    ...
    spot: "6.80",
    dte: "45",
    ibkrPath: "在各大券商下單軟體搜尋「POET」，直接進入那斯達克期權鏈！",
    callK: "8.50",
    callOtm: "+25.0%",
    callBid: "0.45",
    callAsk: "0.65",
...
export function buildInternationalOptionFlexMessages(fact: InternationalOptionFact): LineOutboundMessage[] {
  const bodyContents = [
    ...
    box([
      text("💡 交易路徑與交易所確認", "xs", "#1D4ED8", { weight: "bold" }),
  ...
  const bubble = {
    ...
    size: "mega",
    header: box([
      text(`期權限價與流動性觀測 · ${fact.country}市場`, "xs", "#CBD5E1"),
  ...
  const messages: LineOutboundMessage[] = [
    {
      type: "flex",
      altText: `【${fact.symbol} 期權價格推薦與操作指引】K 履約價、限價區間與年化收益率`,
...
export const STOCK_RESEARCH_KNOWLEDGE_BASE: Record<string, StockResearchFact> = {
  AAOI: {
    chineseName: "祥茂光電",
    originalName: "Applied Optoelectronics",
  ...
  TSEM: {
    chineseName: "高塔半導體",
    originalName: "Tower Semiconductor",
  ...
  SIVE: {
    chineseName: "思維斯半導體",
    originalName: "Sivers Semiconductors",
  ...
  POET: {
    chineseName: "POET 科技",
    originalName: "POET Technologies",
  ...
  STM: {
    chineseName: "意法半導體",
    originalName: "STMicroelectronics",
  ...
  AMAT: {
    chineseName: "應用材料",
    originalName: "Applied Materials",
  ...
  CEG: {
    chineseName: "星座能源",
    originalName: "Constellation Energy",
  ...
  TXN: {
    chineseName: "德州儀器",
    originalName: "Texas Instruments",
...
export async function v213Top20LineAnswer(env: PresentationEnv, query: ParsedQuery): Promise<LineOutboundMessage[] | string | null> {
  ...
  if (query.intent === "options") {
    ...
    if (style === "text") {
      ...
      if (intlOption) {
        return [
          `📈【${intlOption.symbol} 期權限價與對沖觀測・${intlOption.country} 各大券商】`,
