...
def fixture():
    ...
    data['router_processes'] = [{'pid': 1001, 'parent_pid': 1, 'started_utc': '2026-09-06T00:00:00Z', 'binary_sha256': '0' * 64},
                                {'pid': 1002, 'parent_pid': 1001, 'started_utc': '2026-09-06T00:00:01Z', 'binary_sha256': '0' * 64}]
...
class PiLiveEvidenceTests(unittest.TestCase):
    def test_synthetic_complete_pi_contract_and_fail_closed_mutations(self):
        ...
        for change in [lambda d: d.update(router_processes_unchanged=False), lambda d: d.update(schema_version=True), lambda d: d.update(exact_model='qwen38-q6'),
