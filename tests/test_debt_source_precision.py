...
class DebtSourcePrecisionTests(unittest.TestCase):
    ...
    def test_actual_standalone_finalizer_requires_pinned_bundle_preserves_it_and_all_clocks(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            paths['v213'].write_bytes(builder.json_bytes(fixture.scheduled.build(value['report'],fixture.no_orders(value['report']),fixture.names_for(value['report']),**fixture.evidence_inputs(value['report']))))
