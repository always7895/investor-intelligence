...
## CLAIM TAXONOMY (23 classes, routing PENDING)
...
Canonical declaration: [source-claim-taxonomy.json](../config/source-claim-taxonomy.json). Inventory is not routing or publication eligibility.
