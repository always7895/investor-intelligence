...
$preflight=Join-Path $ProjectRoot 'scripts\v213_r75_activation_preflight_entry.py'
...
foreach($path in @($preflight,$core)){
...
try{
    ...
    Write-Host ("V213_DIVERSIFIED_SOURCE_PREFLIGHT = PASS; families={0}; official={1}; bls_present={2}; bundle_sha256={3}"-f$preflightResult.successful_family_count,$preflightResult.official_family_count,$preflightResult.bls_present,$preflightResult.bundle_sha256) -ForegroundColor Green
