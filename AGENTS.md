...
- Local runtime independence (100% local AI, $0 paid, no cloud fallback) is a LOCAL v213-gateway capability: PRIMARY_REASONER + local Mapika DECISION_ROUTER, fail-closed guards, declared `min_decision_confidence` 0.70. Not a Worker change/release. [LOCAL_RUNTIME_INDEPENDENCE](docs/LOCAL_RUNTIME_INDEPENDENCE.md)
