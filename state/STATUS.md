...
1. Sept10 fresh isolated QA now PASS with free service; complete exact-source Windows/package/download verification. Respect free quotas; never use paid/account fallback or stale receipts. Formal release remains blocked by the remaining data/install/publication gates.
