...
- Follow-up P0/P1/P2 = 0/0/1: all P1 items complete (SDK bytes+standalone, Serenity research, Windows/package gates, standalone delivery + GitHub recovery verification). Remaining: user acceptance, then conditional cleanup (evidence migration + approved deletion). P2: unowned InvestorDailyBriefing legacy task.
