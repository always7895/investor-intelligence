...
- Follow-up P0/P1/P2 = 0/2/1: (1) ~~SDK standalone packaging self-test~~ DONE; (2) standalone D:/Investor-Intelligence-LINE-Pi delivery (verified immutable package + standalone SDK + project-local Q5/Serenity config) + GitHub recovery verification + conditional cleanup of obsolete dev/temp copies. P2: unowned InvestorDailyBriefing legacy task.
