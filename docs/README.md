...
- [TASK0-3E_CLAIM_SOURCE_FEASIBILITY](../documents/TASK0-3E_CLAIM_SOURCE_FEASIBILITY.md) — claim source identity + gap analysis + feasibility (3E research evidence)
- [TASK0-3F_SMCI_PUBLIC_DISCOVERY](../documents/TASK0-3F_SMCI_PUBLIC_DISCOVERY.md) — bounded public discovery for SMCI revenue claim (3F research evidence)
- [TASK0-3G_CURRENT_PUBLICATION_TRIAGE](../documents/TASK0-3G_CURRENT_PUBLICATION_TRIAGE.md) — current publication triage + runtime path correction (3G)
